...
template<class UListItem, const int options, const int tstacksize, const int tblocksize>
unsigned int UList<UListItem, options, tstacksize, tblocksize>::Size(){
	return size_used;
}

template<class UListItem, const int options, const int tstacksize, const int tblocksize>
unsigned int UList<UListItem, options, tstacksize, tblocksize>::Blocks(){
	UListData<UListItem> *p = data;
	int s = 0;
...
template<class UListItem, const int options, const int tstacksize, const int tblocksize>
void UList<UListItem, options, tstacksize, tblocksize>::Clean(){
	UListData<UListItem> *p = data, *d;
	int pos = 0;
