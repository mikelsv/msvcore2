...
#define STORM_DEFINE_NEW_DELETE(cls) static OList<cls> storm_items_list; \
	virtual storm_item* storm_new(){ return storm_items_list.NewE(); return 0; } \
	virtual void storm_delete(storm_item *el){ storm_items_list.Free((cls*)el); } \
	public: static cls* static_storm_new(){ return storm_items_list.NewE(); return 0; }
